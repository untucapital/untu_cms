<?php
	...
	if ($state == 'progress'){$url = '/loanStatus/ACCEPTED/Unassigned/'.$_SESSION['branch'];}
...
<html>
	...
	<body>
        ...
        <script>
            var caseloads = <?php echo json_encode($caseloads); ?>
            // echo "var caseloads = " . json_encode($caseloads) . ";";
        </script>
        <!-- js -->
