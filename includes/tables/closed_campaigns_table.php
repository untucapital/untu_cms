    ...
    <div class="pb-20">
        <table class="data-table table stripe hover multiple-select-row nowrap">
            ...
            foreach($data as $application):
                ...
                if($application["campaignStatus"] =="closed" && $application["branchName"] =="belvedere" && $application["allocatedLoanOfficer"] =="vovo"){
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                    <a class="dropdown-item" href="view-campaign.php?id=<?=$application["id"] ?>"><i class="dw dw-edit2"></i> View</a>
