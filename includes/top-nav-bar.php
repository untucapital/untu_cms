				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						...
						>
							...
							>
							<a class="dropdown-item" href="../login_signup/logout-user.php"><i class="dw dw-logout"></i> Log Out</a>
						</div>
					</div>
				</div>
				<!-- <div class="github-link">
					<a href="https://github.com/dropways/deskapp" target="_blank"><img src="../vendors/images/github.#EA220F" alt=""/></a>
				</div> -->
			</div>
		</div>