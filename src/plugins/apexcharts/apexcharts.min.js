            ...
            value: function (t, e, i, a, s, r, n, o) {
              ...
              s || (s = t.attr("pathFrom")),
                ...
                (!s || s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) &&
                  (s = "M 0 ".concat(h.globals.gridHeight)),
                (r.indexOf("undefined") > -1 || r.indexOf("NaN") > -1) &&
                  (r = "M 0 ".concat(h.globals.gridHeight)),
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              ...
              if (
                ...
                a.config.xaxis.convertedCatToNumeric &&
                  (o = a.globals.categoryLabels.indexOf(t.x)),
                  (s = this.annoCtx.helpers.getStringX(t.x));
                var l = t.y;
                null === t.y && (l = a.globals.series[t.seriesIndex][o]),
                  (r =
    ...
    S = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.yAxisAnnotations = new m(this)),
                ...
                tooltip: {
                  ...
                  custom: function (t) {
                    ...
                    if (void 0 === n.config.tooltip.x.formatter)
                      ...
                      (u = n.config.tooltip.x.formatter(o)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (void 0 === t.yaxis ||
                ...
                t.yaxis.constructor !== Array
                  ? (t.yaxis = [g.extend(e.yAxis, t.yaxis)])
                  : (t.yaxis = g.extendArray(t.yaxis, e.yAxis));
              var i = !1;
              return (
                ...
                i &&
                  t.series.length !== t.yaxis.length &&
                  t.series.length &&
                  (t.yaxis = t.series.map(function (i, a) {
                    if (
                      (i.name || (t.series[a].name = "series-".concat(a + 1)),
                      t.yaxis[a])
                    )
                      return (
                        (t.yaxis[a].seriesName = t.series[a].name), t.yaxis[a]
                      );
            ...
            value: function (t) {
              ...
              if (
                ...
                -1 === n.indexOf("rgb")
                  ? (h = g.hexToRgba(n, l))
                  : n.indexOf("rgba") > -1 &&
                    (l = "0." + g.getOpacityFromRGBA(n)),
                t.opacity && (l = t.opacity),
                "pattern" === o && (a = this.handlePatternFill(a, n, l, h)),
                "gradient" === o &&
                  (s = this.handleGradientFill(s, n, l, this.seriesIndex)),
                "image" === o)
              ) {
          ...
          },
          {
            ...
            value: function (t, e, i, a) {
              var s,
                ...
                d =
                  void 0 === n.fill.gradient.opacityFrom
                    ? i
                    : Array.isArray(n.fill.gradient.opacityFrom)
                    ? n.fill.gradient.opacityFrom[a]
                    : n.fill.gradient.opacityFrom,
                u =
                  void 0 === n.fill.gradient.opacityTo
                    ? i
                    : Array.isArray(n.fill.gradient.opacityTo)
                    ? n.fill.gradient.opacityTo[a]
                    : n.fill.gradient.opacityTo;
              if (
                ((s = e),
                (r =
                  void 0 === n.fill.gradient.gradientToColors ||
                  0 === n.fill.gradient.gradientToColors.length
                    ? "dark" === n.fill.gradient.shade
                      ? h.shadeColor(
                          -1 * parseFloat(n.fill.gradient.shadeIntensity),
                          e
                        )
                      : h.shadeColor(
                          parseFloat(n.fill.gradient.shadeIntensity),
                          e
                        )
                    : n.fill.gradient.gradientToColors[o.seriesNumber]),
              ...
              return l.drawGradient(
                ...
                u,
                o.size,
                n.fill.gradient.stops,
                n.fill.gradient.colorStops,
                a
              );
            },
          },
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this.w,
                ...
                n = e.width,
                o = e.height;
              return new p(this.ctx).drawRect(
                e.x - s,
                e.y - r / 2,
                n + 2 * s,
                o + r,
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              var i = this,
                a = this.w,
                s = a.globals.dom.baseEl.querySelectorAll(
            ...
            value: function (t) {
              ...
              if (e.xaxis.categories.length > 0) i.labels = e.xaxis.categories;
                ...
                if (
                  ...
                  new L(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]),
                ...
                e.x <
                  n.textRect.width /
                    (r.globals.rotateXLabels
                      ? Math.abs(r.config.xaxis.labels.rotate) / 20
                      : 1.01) +
                    n.x && (e.text = "");
              }
              return e;
            ...
            value: function () {
              ...
              Array.prototype.forEach.call(a, function (t) {
                ...
                e &&
                  ...
                  e.setAttribute("x1", -500),
                  e.setAttribute("x2", -500)),
                i &&
                  (i.setAttribute("y", -100),
                  i.setAttribute("y1", -100),
              ...
              if (i.config.xaxis.labels.show)
                for (
                  var d = function (s) {
                      ...
                      (h = e.axesUtils.checkForOverflowingLabels(
                        s,
                        h,
                        c,
                        e.drawnLabels,
              ...
              if (
                ...
                for (
                  ...
                  i.config.grid.xaxis.lines.show &&
                    ...
                    new O(this.ctx).drawXaxisTicks(s, this.elg),
        ...
        a(t, [
          {
            ...
            value: function (t, e, i) {
              var a =
                ...
                n = this.w;
              if (
                ("dataPoints" === s && (s = n.globals.dataPoints - 1),
        ...
        a(t, [
          {
            ...
            value: function (t) {
              ...
              var y = e.config.yaxis[t].axisBorder,
                w = 31 + y.offsetX;
              if (
                (e.config.yaxis[t].opposite && (w = -31 - y.offsetX), y.show)
              ) {
                var k = i.drawLine(
                  w,
                  ...
                  n = function () {
                    ...
                    if (n > a) {
                      ...
                      for (var l = 0; l < s.length; l++)
                        n < s[l].breakpoint &&
                          ((t = I.extendArrayProps(r, s[l].options)),
                          (t = g.extend(i.config, t)),
                          e.overrideResponsiveOptions(t));
                  };
                if (t) {
                ...
                void 0 === e.config.colors
                  ...
                  : ((e.globals.colors = e.config.colors),
                    e.globals.axisCharts &&
                      ...
                      e.config.colors.length === e.config.series.length &&
                      (e.globals.colors = e.config.colors.map(function (i, a) {
              ...
              ["fill", "stroke"].forEach(function (i) {
                ...
                void 0 === e.config.plotOptions.radar.polygons.fill.colors
                  ? (e.globals.radarPolygons.fill.colors = [
                      "dark" === e.config.theme.mode ? "#202D48" : "#fff",
                    ])
                  : (e.globals.radarPolygons.fill.colors =
                      e.config.plotOptions.radar.polygons.fill.colors),
                this.pushExtraColors(e.globals.radarPolygons.fill.colors, 20),
                void 0 === e.config.markers.colors
                  ? (e.globals.markers.colors = d)
                  : (e.globals.markers.colors = e.config.markers.colors),
                      ...
                      if (
                        ...
                        var s = e.dCtx.timescaleLabels[0],
                          ...
                          l =
                            s.position -
                            n / 1.75 +
                            (t.opposite ? 0 : e.dCtx.yAxisWidthLeft);
              ...
              return (
                e.config.yaxis.map(function (s, r) {
                  if (
                    s.show &&
                    s.labels.show &&
                    e.globals.yAxisScale[r].result.length
                  ) {
                    ...
                    if (
                      ((void 0 !== o && 0 !== o.length) ||
                        (o = e.globals.yAxisScale[r].niceMax),
                      e.globals.isBarHorizontal)
                    ) {
                      a = 0;
                      ...
                      (o = n((o = g.getLargestStringFromArr(h)), {
                        ...
                        (l = t.dCtx.dimHelpers.getLargestStringFromMultiArr(
                          o,
                          h
                        ));
                    }
                    var c = new p(t.dCtx.ctx),
                      ...
                      u = d;
                    o !== l && (u = c.getTextRects(l, s.labels.style.fontSize)),
                      i.push({
              ...
              var t = this.w,
                ...
                r = function (r, n) {
                  ...
                  r.width > 0 && !o
                    ...
                    : (l = o || !t.config.yaxis[n].show ? 0 : 5),
                    t.config.yaxis[n].opposite ? (a += l) : (i += l),
                    (e += l);
                };
              return (
    ...
    it = (function () {
      function t(i) {
        e(this, t),
          ...
          (this.dimHelpers = new Q(this)),
          (this.dimYAxis = new tt(this)),
          (this.dimXAxis = new K(this)),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.dimGrid.setGridXPosForDualYAxis(s, a),
                new G(this.ctx).setYAxisXPosition(a, s);
            },
          },
          {
            ...
            value: function () {
              ...
              var s =
                  "pie" === i.chart.type || "donut" === i.chart.type
                    ? "pie"
                    : "radialBar",
        ...
        a(t, [
            ...
            value: function (t) {
              ...
              if (e.globals.dataChanged) {
                ...
                for (var f = 0; f < e.globals.previousPaths.length; f++)
                  (c =
                    (this.fullAngle * g.negToZero(e.globals.previousPaths[f])) /
                    d),
              ...
              if ("donut" === e.config.chart.type) {
                ...
                w.attr({
                  ...
                  fill: e.config.plotOptions.pie.donut.background
                    ? e.config.plotOptions.pie.donut.background
                    : "transparent",
                }),
                  o.add(w);
              }
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return "donut" === r.config.chart.type
                ? []
                    .concat(m, [
                      "L",
                      p.x,
                    ...
                    .join(" ")
                : "pie" === r.config.chart.type
                ? [].concat(m, ["L", e.centerX, e.centerY, "L", c, d]).join(" ")
                : [].concat(m).join(" ");
            },
          },
          {
                  ...
                  if (s.globals.selectedDataPoints[0].length > 0) {
                    var h = s.globals.selectedDataPoints[0],
                      c = s.globals.dom.baseEl.querySelector(
                        ".apexcharts-"
                          .concat(s.config.chart.type.toLowerCase(), "-slice-")
                          .concat(h)
                      );
            ...
            value: function (t, e) {
              ...
              if (a.globals.axisCharts || "radialBar" === a.config.chart.type) {
                ...
                if ("pie" === o || "donut" === o) {
                  ...
                  h.pathMouseDown(n.members[0], null),
                    c.printDataLabelsInner(n.members[0].node, l);
                }
                n.fire("click");
              }
            },
    ...
    rt = (function () {
      function t(i, a) {
        e(this, t),
          ...
          (this.legendHelpers = new st(this));
      }
      return (
        a(t, [
          {
              ...
              for (
                ...
                (k.background = a[o]),
                  ...
                  t.config.legend.markers.fillColors &&
                    ...
                    (k.background = t.config.legend.markers.fillColors[o]),
                  (k.height = Array.isArray(b)
                    ? parseFloat(b[o]) + "px"
                    : parseFloat(b) + "px"),
                  (k.width = Array.isArray(m)
                    ? parseFloat(m[o]) + "px"
                    : parseFloat(m) + "px"),
                  (k.left = Array.isArray(f) ? f[o] : f),
                  (k.top = Array.isArray(x) ? x[o] : x),
                  (k.borderWidth = Array.isArray(v) ? v[o] : v),
                  (k.borderColor = Array.isArray(y) ? y[o] : y),
                  (k.borderRadius = Array.isArray(w)
                    ? parseFloat(w[o]) + "px"
                    : parseFloat(w) + "px"),
                ...
                S.classList.add("apexcharts-legend-text"),
                  (S.innerHTML = Array.isArray(l) ? l.join(" ") : l);
                var C = t.config.legend.labels.useSeriesColors
                  ? t.globals.colors[o]
                ...
                C || (C = t.config.chart.foreColor),
                  ...
                  (S.style.fontWeight = t.config.legend.fontWeight),
                ...
                if (!t.config.legend.showForZeroSeries)
                  0 === L.getSeriesTotalByIndex(o) &&
                    L.seriesHaveSameValues(o) &&
                    !L.isSeriesNull(o) &&
                ...
                t.config.legend.showForNullSeries ||
                  (L.isSeriesNull(o) &&
                    ...
                    -1 ===
                      t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) &&
                    A.classList.add("apexcharts-hidden-null-series")),
                  ...
                  (t.globals.dom.elLegendWrap.style.height = t.config.legend
                    ...
                    : ""),
                  p.setAttrs(A, { rel: o + 1, "data:collapsed": h || c }),
                  (h || c) && A.classList.add("apexcharts-inactive-legend"),
                  t.config.legend.onItemClick.toggleDataSeries ||
                    A.classList.add("apexcharts-no-click");
              }
              ...
              if ("heatmap" === e.config.chart.type || this.isBarsDistributed) {
                if (i) {
                  ...
                  this.ctx.events.fireEvent("legendHover", [
                    ...
                    new F(this.ctx).highlightRangeInSeries(t, t.target);
                }
              } else
                !t.target.classList.contains("apexcharts-inactive-legend") &&
                  i &&
                  new F(this.ctx).toggleSeriesOnHover(t, t.target);
            },
          },
          {
            key: "onLegendClick",
            ...
            value: function (t, e) {
              ...
              if (
                ...
                if (i.config.chart.zoom.autoScaleYaxis)
                  n = new B(this.ctx).autoScaleY(this.ctx, n, { xaxis: a });
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.config.chart.zoom.autoScaleYaxis &&
                (s = new B(this.ctx).autoScaleY(this.ctx, s, { xaxis: r }));
                      ...
                      o
                        ? ((f = i.getFormatters(p)),
                          ...
                          ((i.tooltipUtil.hasBars() &&
                            ...
                            0 === l.globals.series[p][s]) ||
                            void 0 === l.globals.series[p][s]) &&
                            (e = void 0))
                        : (e = x(a));
                    }
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.i,
                ...
                p = null;
              (p = s[i].children),
                h.config.tooltip.fillSeriesColor &&
                  ((s[i].style.backgroundColor = l),
                  (p[0].style.display = "none")),
                c.showTooltipTitle &&
                  (null === c.tooltipTitle &&
                    (c.tooltipTitle = h.globals.dom.baseEl.querySelector(
                      ".apexcharts-tooltip-title"
                    )),
                  (c.tooltipTitle.innerHTML = g)),
                c.blxaxisTooltip &&
                  (c.xaxisTooltipText.innerHTML = "" !== u ? u : g);
              ...
              p[0] &&
                ...
                (h.config.tooltip.marker.fillColors &&
                  Array.isArray(h.config.tooltip.marker.fillColors) &&
                  (l = h.config.tooltip.marker.fillColors[e]),
                (p[0].style.backgroundColor = l)),
              h.config.tooltip.marker.show || (p[0].style.display = "none"),
              null !== f) &&
                ((s[i].querySelector(
                  ".apexcharts-tooltip-text-z-label"
                ).innerHTML = h.config.tooltip.z.title),
                (s[i].querySelector(
                  ".apexcharts-tooltip-text-z-value"
                ).innerHTML = void 0 !== f ? f : ""));
              if (o && p[0] && c.tooltipTitle)
                if (
                  (null == d || h.globals.collapsedSeriesIndices.indexOf(i) > -1
                    ? (p[0].parentNode.style.display = "none")
                    : (p[0].parentNode.style.display =
                        h.config.tooltip.items.display),
                  0 === h.globals.stackedSeriesTotals[a])
                ) {
                  for (
                    var m = !0, v = 1;
                    v < h.globals.seriesYvalues.length;
                    v++
                  )
                    h.globals.seriesYvalues[v][a] !==
                      h.globals.seriesYvalues[v - 1][a] && (m = !1);
                  c.tooltipTitle.style.display = m
                    ? "none"
                    : h.config.tooltip.items.display;
                } else
                  c.tooltipTitle.style.display = h.config.tooltip.items.display;
            },
          },
          {
              ...
              if (
                ...
                for (var c = 0; c < a.globals.series.length; c++) {
                  ...
                  if (
                    ...
                    null === u || isNaN(u)
                      ? l[f] && l[f].setAttribute("r", 0)
                      : (l[f] && l[f].setAttribute("r", o),
                        l[f] && l[f].setAttribute("cy", u));
                  }
                }
            ...
            value: function (t) {
              ...
              !i.tooltipUtil.hasBars() ||
                ...
                (this.tConfig.onDatasetHover.highlightDataSeries &&
                  new F(e).toggleSeriesOnHover(s, s.target.parentNode));
          ...
          },
          {
            ...
            value: function (t, e, i, a, s) {
              ...
              if (void 0 !== i[a][s] || null !== i[a][s]) {
                ...
                switch (
                  (g && (u = -e.barWidth / 2 - e.strokeWidth),
                  t.config.chart.stacked ||
                    ("rounded" === this.barCtx.barOptions.endingShape &&
                      (d += u / 2)),
                  this.barCtx.barOptions.endingShape)
              ...
              for (var o = 0, l = 0; o < t.length; o++, l++) {
                ...
                for (
                  var S = a.group({
                    ...
                    C = 0;
                  C < i.globals.dataPoints;
                  C++
                ) {
                  var L = this.barHelpers.getStrokeWidth(o, C, v),
                    P = null,
                    T = {
                      indexes: { i: o, j: C, realIndex: v, bc: l },
                      x: f,
                      y: x,
                      strokeWidth: L,
                      elSeries: y,
                  ...
                  this.isHorizontal
                    ? ((P = this.drawBarPaths(
                        n({}, T, { barHeight: w, zeroW: u, yDivision: c })
                      )),
                      (k = this.series[o][C] / this.invertedYRatio))
                    : ((P = this.drawColumnPaths(
                        n({}, T, { xDivision: h, barWidth: k, zeroH: d })
                      )),
                      (w = this.series[o][C] / this.yRatio[this.yaxisIndex])),
                    (x = P.y),
                    (f = P.x),
                    C > 0 && m.push(f + k / 2),
                    b.push(x);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              h.globals.isXNumeric &&
                (n =
                  (h.globals.seriesX[d][g] - h.globals.minX) /
                    this.invertedXRatio -
                  i);
              ...
              var v = {
                  ...
                  x: (r =
                    void 0 === this.series[d][g] || null === this.series[d][g]
                      ? s
                      : s +
                        this.series[d][g] / this.invertedYRatio -
                        2 *
                          (this.isReversed
                            ? this.series[d][g] / this.invertedYRatio
                            : 0)),
              ...
              if (
                ...
                f >= this.barOptions.colors.backgroundBarColors.length &&
                  (f = 0);
            ...
            value: function (t) {
              ...
              if (h.globals.isXNumeric) {
                ...
                h.globals.seriesX[d].length ||
                  (x = h.globals.maxValsInArrayIndex),
                  (i =
                    (h.globals.seriesX[x][g] - h.globals.minX) / this.xRatio -
                    (r * this.seriesLen) / 2);
              }
        ...
        a(i, [
          {
            ...
            value: function (t, e) {
              var i = this,
                a = this.w;
              (this.graphics = new p(this.ctx)),
                (this.bar = new bt(this.ctx, this.xyRatios));
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.series.length > 1 &&
                g !== this.endingShapeOnSeriesNumber &&
                (y.path = this.graphics.line(y.newX, d + a - s)),
                this.xArrj.push(y.newX),
                this.xArrjF.push(Math.abs(e - y.newX)),
                this.xArrjVal.push(this.series[g][u]);
              var w = this.graphics.move(e, d),
                k = this.graphics.move(e, d);
              if (
                (c.globals.previousPaths.length > 0 &&
                  (k = this.bar.getPreviousPath(f, u, !1)),
                (w =
                  w +
                  this.graphics.line(y.newX, d) +
                  y.path +
                  this.graphics.line(e, d + a - s) +
                  this.graphics.line(e, d)),
                (k =
                  k +
                  this.graphics.line(e, d) +
                  this.graphics.line(e, d + a - s) +
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                (c > 0 && !h.globals.isXNumeric) ||
                (c > 0 &&
                  h.globals.isXNumeric &&
                  h.globals.seriesX[c - 1][d] === h.globals.seriesX[c][d])
              ) {
                var v,
                  y,
              ...
              this.yArrj.push(C.newY),
                this.yArrjF.push(Math.abs(p - C.newY)),
                this.yArrjVal.push(this.series[c][d]);
              var L = this.graphics.move(x, p),
                P = this.graphics.move(x, p);
              if (
                (h.globals.previousPaths.length > 0 &&
                  (P = this.bar.getPreviousPath(g, d, !1)),
                (L =
                  L +
                  this.graphics.line(x, C.newY) +
                  C.path +
                  this.graphics.line(x + r - o, p) +
                  this.graphics.line(x - o / 2, p)),
                (P =
                  P +
                  this.graphics.line(x, p) +
                  this.graphics.line(x + r - o, p) +
                  this.graphics.line(x + r - o, p) +
                  this.graphics.line(x + r - o, p) +
                  this.graphics.line(x - o / 2, p)),
                h.config.plotOptions.bar.colors.backgroundBarColors.length >
                  0 && 0 === c)
              ) {
                u >=
                  h.config.plotOptions.bar.colors.backgroundBarColors.length &&
                ...
                var T = h.config.plotOptions.bar.colors.backgroundBarColors[u],
                  z = this.graphics.drawRect(
                    ...
                    0,
                    T,
                    h.config.plotOptions.bar.colors.backgroundBarOpacity
                  );
              ...
              if (
                ...
                t.forEach(function (t, o) {
                  ...
                  (d = e.graphics.group({
                    ...
                    i.globals.delayedElements.push({ el: d.node, index: o });
                  var x = {
                      i: o,
                      realIndex: o,
                      animationDelay: o,
                  ...
                  t.forEach(function (t, a) {
                    var s = new X(e.ctx).getMarkerConfig(
                        "apexcharts-marker",
                        o,
                        a
                      ),
        ...
        a(i, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              o.globals.isXNumeric &&
                (i =
                  (o.globals.seriesX[h][c] - o.globals.minX) / this.xRatio -
                  r / 2);
              var b = i + r * this.visibleI;
              void 0 === this.series[h][c] || null === this.series[h][c]
                ? (f = n)
          ...
          },
          {
            ...
            value: function (t) {
              var e = t.indexes,
                ...
                f = c.move(d, o);
              h.globals.previousPaths.length > 0 &&
                (f = this.getPreviousPath(e.realIndex, e.j));
              var x = Math.abs(g - d);
              return (
                (u =
                  c.move(d, o) +
        ...
        a(t, [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              if (s.comboCharts) {
                if (
                  (n.series.length > 0 && b.push(d.draw(n.series, "area", n.i)),
                  h.series.length > 0)
                )
            ...
            value: function () {
              ...
              (a += t.config.grid.padding.bottom),
                ("top" !== t.config.legend.position &&
                  ...
                  (i =
                    new rt(this.ctx).legendHelpers.getLegendBBox().clwh + 10);
              var s = t.globals.dom.baseEl.querySelector(
                ...
                o.forEach(function (r) {
                  ...
                  return (
                    ...
                    e &&
                      "object" === t(e) &&
                      ((r.config = new P(e)),
                      (e = I.extendArrayProps(r.config, e)),
            ...
            value: function (t, e) {
              ...
              return (
                ...
                r.globals.allSeriesCollapsed &&
                  (r.globals.allSeriesCollapsed = !1),
          ...
          extend: {
            ...
            eachAt: function () {
              ...
              if (n.transforms.length) {
                for (
                  i = n.initialTransformation, t = 0, e = n.transforms.length;
                  t < e;
                  t++
                ) {
                  ...
                  o instanceof a.Matrix
                    ? (i = o.relative
                        ? i.multiply(
                            new a.Matrix().morph(o).at(n.ease(this.pos))
                          )
                        : i.morph(o).at(n.ease(this.pos)))
                    : (o.relative || o.undo(i.extract()),
                      (i = i.multiply(o.at(n.ease(this.pos)))));
                }
                r.matrix(i);
              }
              return this;
          ...
          extend: {
            ...
            each: function (t, e) {
              ...
              for (i = 0, s = r.length; i < s; i++)
                r[i] instanceof a.Element && t.apply(r[i], [i, r]),
                  e && r[i] instanceof a.Container && r[i].each(t, e);
              return this;
            },
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.axes = new U(this.ctx)),
                (this.ctx.core = new Pt(this.ctx.el, this.ctx)),
                (this.ctx.data = new D(this.ctx)),
                (this.ctx.grid = new W(this.ctx)),
                (this.ctx.coreUtils = new I(this.ctx)),
                (this.ctx.crosshairs = new q(this.ctx)),
                (this.ctx.events = new _(this.ctx)),
                (this.ctx.localization = new j(this.ctx)),
                (this.ctx.options = new A()),
                (this.ctx.responsive = new Z(this.ctx)),
                (this.ctx.series = new F(this.ctx)),
                (this.ctx.theme = new $(this.ctx)),
                (this.ctx.formatters = new R(this.ctx)),
                (this.ctx.titleSubtitle = new J(this.ctx)),
                (this.ctx.legend = new rt(this.ctx)),
                (this.ctx.toolbar = new nt(this.ctx)),
                (this.ctx.dimensions = new it(this.ctx)),
                (this.ctx.updateHelpers = new Tt(this.ctx)),
                (this.ctx.zoomPanSelection = new ot(this.ctx)),
                (this.ctx.w.globals.tooltip = new ft(this.ctx));
            },
          },
        ]),
        t
        ...
        [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              i.config.xaxis.convertedCatToNumeric) &&
                new L(i.config).convertCatToNumericXaxis(i.config, this.ctx);
              ...
              (a.comboCharts = s.comboCharts),
                ...
                this.theme.init(),
                new X(this).setGlobalMarkerSize(),
            ...
            value: function () {
              ...
              return new Promise(function (s, r) {
                ...
                if (
                  ...
                  (i.annotations = new S(i)),
                  "back" === a.config.annotations.position &&
                    i.annotations.drawAnnotations(),
                ...
                if (
                  ("front" === a.config.grid.position && i.grid.drawGrid(),
